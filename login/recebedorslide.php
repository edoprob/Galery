...
if (isset($_FILES['arquivodata']) && !empty($_FILES['arquivodata'])) {
	...
	if (isset($arquivo['tmp_name']) && !empty($arquivo['tmp_name'])) {
		...
		if ((isset($arquivo) && !empty($arquivo))) {
			...
			move_uploaded_file($arquivo['tmp_name'], "uploads/slide/".$nomedoarquivo);
			$foto->slideOficial($nomedoarquivo);
			$foto->addSlide($nomedoarquivo);
			unlink("uploads/slide/".$nomedoarquivo);
